...
import io.nekohasekai.sfa.databinding.FragmentOutRootSettingsBinding
...
class OutRootSettingsFragment : Fragment() {

    private var binding: FragmentOutRootSettingsBinding? = null
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        val binding = FragmentOutRootSettingsBinding.inflate(inflater, container, false)
